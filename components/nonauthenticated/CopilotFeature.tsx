...
const CopilotFeature = (props: Props) => {
  ...
  return (
    ...
    <HoverCard backgroundColor="#7ee787" direction="" left="40" >
      <div className="md:flex flex-col md:space-y-20 flex-1 p-8 sm:p-10 lg:py-16 lg:pl-32 lg:pr-68 justify-between ">
        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
          <span className="text-white font-medium">Codegnan Solutions</span> provides you your seperate code editor to solves challenges, complete assigments and participate in various contests.
        </p>
        <div>
          <a
          ...
          >
            ...
            <div
              className={` ${hovered ? 'w-11/12 scale-100' : 'w-0 scale-0'} origin-left  transition ease-in duration-300 h-[2.5px] bg-white rounded-full`}
            ></div>
          </a>
        </div>
      </div>
            ...
            <div className="overflow-x-auto pt-2 px-2 mb-0 border-b-[0.5px] border-[#30363d] ">
              <div className="flex items-center bg-[#161b22] text-[#7d8590] tab-nav">
                <button
                  ...
                  type="button"
                  className={`flex items-center  py-2 px-4 ${showPy ? 'border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]' : ''}  `}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    role="img"
                ...
                <button
                  ...
                  type="button"
                  className={`flex items-center py-2 px-4 ${showJs ? 'border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]' : ''}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    role="img"
                ...
                <button
                  ...
                  type="button"
                  className={`flex items-center py-2 px-4 ${showGo ? 'border-[0.5px] rounded-t-md border-b-[0] text-white border-[#30363d] bg-[#0d1117]' : ''} `}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    role="img"
                ...
                >
                  <pre className="">
                    <span className="code-editor-line-mktg">
                      ...
                      <span className="pl-s1">pyplot</span>{' '}
                      <span className="pl-k">as</span>{' '}
                  ...
                  >
                    ...
                    <div className="rounded-tl-none  bg-[#1f6feb] absolute color-fg-on-emphasis rounded-md font-bold flex items-center mt-1 js-type-row p-2 f5 row-is-visible">
                      Run Code
                    </div>
                  </motion.div>
                </div>
                ...
                >
                  <pre className="">
                    <span className="code-editor-line-mktg d-inline-block">
                      ...
                      <span className="pl-c1">=</span>{' '}
                      <span className="pl-c1">3600</span>
                    </span>
                  </pre>
                  <pre className="">
                    <motion.span
                  ...
                  >
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                        ...
                        <span className="pl-c1">/</span>{' '}
                        <span className="pl-c1">60</span>
                      </span>
                    </pre>
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                        <span className="pl-k">const</span>{' '}
                        <span className="pl-s1">days</span>{' '}
                        <span className="pl-c1">=</span>{' '}
                        <span className="pl-s1">hours</span>{' '}
                        <span className="pl-c1">/</span>{' '}
                        <span className="pl-c1">24</span>
                      </span>
                    </pre>
                    <pre className=" bg-[#388bfd1a]">
                      <span>
                    ...
                    <div className="rounded-tl-none shadow-xl bg-[#1f6feb] absolute color-fg-on-emphasis rounded-md font-bold flex mt-1 items-center js-type-row p-2 f5 row-is-visible">
                      Run Code
                    </div>
                  </motion.div>
                </div>
                ...
                >
                  ...
                  <pre className="">
                    ...
                    >
                      ...
                      <motion.span
                        variants={item}
                        className="pl-smi js-type-letters"
                      >
                        int
                      </motion.span>
                      <motion.span variants={item} className="js-type-letters">
